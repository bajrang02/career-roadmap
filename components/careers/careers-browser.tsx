...
export function CareersBrowser({
  ...
  careers: (RoadmapIndexEntry & { slug: string })[];
  ...
  return (
    <div className="mx-auto max-w-7xl px-4 py-10 sm:px-6">
      <div className="flex flex-wrap items-end justify-between gap-4">
        <div>
          <p className="eyebrow">
            {all.length} careers · {domains.length} categories ·{" "}
          ...
          <p className="mt-2 max-w-xl body-text">
            {all.length} technical careers across {domains.length} domains — software,
